<template>
  ...
  >
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="100px">
      ...
      <el-form-item label="消息内容" prop="content" v-show="dataForm.msgType === 'text'">
        <el-input v-model="dataForm.content" type="textarea" placeholder="消息内容"></el-input>
      </el-form-item>
      <el-form-item label="消息顺序">
        <el-input v-model="dataForm.seq" type="number" placeholder="消息顺序"></el-input>
      </el-form-item>
    </el-form>
