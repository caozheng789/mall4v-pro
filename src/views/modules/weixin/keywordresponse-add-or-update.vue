  ...
  >
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="100px">
      <el-form-item label="关键字">
        <el-input placeholder="请输入关键字" v-model="dataForm.keyword"></el-input>
      </el-form-item>
      <el-form-item label="匹配模式">
        <el-select v-model="dataForm.pptype" placeholder="请选择匹配模式">
          <el-option label="模糊匹配" :value="1"></el-option>
          <el-option label="完全匹配" :value="2"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="消息类型" prop="msgType">
        <el-select v-model="dataForm.msgType" placeholder="请选择消息类型" @change="clearMaterial">
          <el-option
      ...
      <el-form-item label="请选择素材" v-show="dataForm.msgType !== 'text'">
      ...
      >
        <el-input placeholder="请选择素材" v-model="dataForm.content" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="查看" v-if="dataForm.msgType === 'image' || dataForm.msgType === 'news'">
        <img v-if="dataForm.msgType === 'image'" :src="dataForm.content" />
        <a
          v-else-if="dataForm.msgType === 'news' && dataForm.news.url"
          :href="dataForm.news.url"
          target="_blank"
        >查看</a>
      </el-form-item>
      <el-form-item label="回复内容" prop="content" v-if="dataForm.msgType === 'text'">
        <el-input v-model="dataForm.content" type="textarea" placeholder="回复内容"></el-input>
      </el-form-item>
    </el-form>
    ...
    <material-select
      ...
      ref="materialSelect"
      @callBack="materialSelectCallBack"
    ></material-select>
  </el-dialog>
</template>
