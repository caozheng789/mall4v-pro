  ...
  <div class="mod-prod-sku-table">
    <el-form-item>
      ...
      >
        ...
        <el-table-column prop="prodName" label="商品名称" width="250" v-if="tableLeftTitles.length">
          <template slot-scope="scope">
            <el-input v-model="scope.row.prodName" type="textarea" :disabled="!scope.row.status"></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="oriPrice" label="市场价">
          <template slot-scope="scope">
            <el-input-number
              size="small"
        ...
        <el-table-column prop="partyCode" label="商品编码">
          <template slot-scope="scope">
            <el-input v-model="scope.row.partyCode"></el-input>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="volume" label="商品体积(m³)">
          <template slot-scope="scope">
            <el-input-number
              size="small"
