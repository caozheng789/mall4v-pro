<template>
  ...
  >
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="记录ID" prop="refundId">
      ...
      <el-form-item label="订单项ID 全部退款是0" prop="orderItemId">
        <el-input v-model="dataForm.orderItemId"></el-input>
      </el-form-item>
      <el-form-item label="退款编号" prop="refundSn">
        <el-input v-model="dataForm.refundSn"></el-input>
      </el-form-item>
      <el-form-item label="订单支付流水号" prop="flowTradeNo">
        <el-input v-model="dataForm.flowTradeNo"></el-input>
      </el-form-item>
      <el-form-item label="第三方退款单号(微信退款单号)" prop="outRefundNo">
        <el-input v-model="dataForm.outRefundNo"></el-input>
      </el-form-item>
      <el-form-item label="订单支付方式 1 微信支付 2 支付宝" prop="payType">
        <el-input v-model="dataForm.payType"></el-input>
      </el-form-item>
      <el-form-item label="订单支付名称" prop="payTypeName">
      ...
      <el-form-item label="收货备注" prop="receiveMessage">
        <el-input v-model="dataForm.receiveMessage"></el-input>
      </el-form-item>
    </el-form>
