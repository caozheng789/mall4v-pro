<template>
  <el-dialog title="退款处理" :close-on-click-modal="false" :visible.sync="visible" width="80%">
    <el-form
      :model="dataForm"
      ref="dataForm"
      ...
      <div class="mod-order-refundOrderInfo">
        <div class="content">
          <div class="order-number">
            <div class="num-cont">
              ...
              <el-form-item>
                ...
                <div v-else>
                  <el-steps :active="stepsStatus" align-center :process-status="processStatus">
            ...
            <div class="state-cont">
              <div class="state-title">
                <el-form-item label="退货类型:">
                  <template slot-scope="scope">
                    <el-tag v-if="dataForm.applyType == 1" size="small" type="warning">仅退款</el-tag>
                    <el-tag v-if="dataForm.applyType == 2" size="small" type="warning">退货退款</el-tag>
                  </template>
                </el-form-item>
                <el-form-item label="退货方式:">
                  <template slot-scope="scope">
                    <el-tag v-if="dataForm.refundType == 1" size="small" type="warning">整单退款</el-tag>
                    <el-tag v-if="dataForm.refundType == 2" size="small" type="warning">单个物品退款</el-tag>
                  </template>
                </el-form-item>
                <el-form-item v-if="dataForm.decisionTime && !dataForm.refundTime">
                  ...
                  <el-button
                    ...
                    size="small"
                    plain
                    @click="refundRevocation(dataForm.refundSn)"
                  >撤回上一步</el-button>
                </el-form-item>
              </div>
              ...
              <div class="order-info">
                <div class="order-details">
                  ...
                  <template
                    v-if="this.dataForm.refundDelivery && this.dataForm.refundDelivery.deyNu"
                  >
                    <div class="detail-title">
                      <img src="~@/assets/img/car.png" alt />
                    ...
                    <div class="detail-cont">
                      <div class="detail01">
                        <div class="text-width">
                          ...
                          <el-form-item
                            v-if="this.dataForm.refundDelivery && this.dataForm.refundDelivery.senderMobile"
                            label="买家电话:"
                          >
                ...
                <div class="buyers">
                  <div class="detail-title">
                    ...
                    />
                    <el-form-item label="退货凭证:" style="margin-top:22px" label-width="74px"></el-form-item>
                  </div>
                  <div class="buyers-info">
                    <div class="detail02">
                      <div class="refundImg" v-for="(item,index) in refundphotos" :key="index">
                  ...
                  <template
                    v-if="this.dataForm.refundDelivery && this.dataForm.refundDelivery.imgs"
                  >
                    <div class="detail-title" style="margin-top:40px">
                      <img
                        ...
                        style="margin-right:15px"
                      />
                      <el-form-item label="物流凭证:" style="margin-top:22px" label-width="74px"></el-form-item>
                    </div>
                    <div class="buyers-info">
                      <div class="detail02">
                        <div
              ...
              <div class="item-list">
                <el-table :data="dataForm.orderItems" border>
                  <el-table-column prop label="退款商品">
                    <template slot-scope="scope" >
                  ...
                  >
                    <template slot-scope="scope">
                      ...
                      >{{bigProductTotalAmount(scope.row.price, dataForm.goodsNum)}}</span>
                    </template>
                  </el-table-column>
                  <el-table-column prop="actualTotal" label="实付金额" width="180" align="center">
                    <template slot-scope="scope">
                      <span v-if="dataForm.refundType == 1">{{scope.row.actualTotal}}</span>
                      <span
                        v-if="dataForm.refundType == 2"
                      >{{bigActualTotal(scope.row.actualTotal, scope.row.prodCount)}}</span>
                      <el-tag
              ...
              <div class="sellerRemark" v-if="dataForm.applyType === 2">
                <el-row>
                  <el-col :span="2">
                    <div>收货地址：</div>
                  </el-col>
                  <el-col :span="22">
                    <div v-if="dataForm.returnMoneySts == 1">
                      <el-select v-model="dataForm.refundAddrId" placeholder="请选择">
                        <el-option
                    ...
                    >{{this.dataForm.refundDelivery.receiverAddr}}</div>
                  </el-col>
                </el-row>
              </div>
              ...
              <div class="sellerRemark" v-if="isAgreeRefund === 3">
                <el-row>
                  ...
                  <el-col :span="22">
                    <div>
                      <el-input type="textarea" v-model="dataForm.rejectMessage" :rows="4"></el-input>
                    </div>
                  </el-col>
                </el-row>
              </div>
          ...
          <div class="order-log">
            ...
            <div class="log-cont">
              <el-form-item v-if="dataForm.applyTime" label-width="10px">
              ...
              <el-form-item v-if="dataForm.shipTime" label-width="10px">
                <span>{{dataForm.shipTime}} 买家发货,等待商家收货</span>
              </el-form-item>
              <el-form-item v-if="dataForm.receiveTime" label-width="10px">
                <span>{{dataForm.receiveTime}} 商家已收货，等待商家同意退款</span>
              </el-form-item>
              <el-form-item v-if="dataForm.decisionTime" label-width="10px">
                <span>{{dataForm.decisionTime}} 同意退款，等待发放退款</span>
              </el-form-item>
              <el-form-item v-if="dataForm.refundTime" label-width="10px">
              ...
              <el-form-item v-if="dataForm.returnMoneySts === 6" label-width="10px">
                <span>{{dataForm.cancelTime}} 退款关闭 买家已撤销</span>
              </el-form-item>
              <el-form-item v-if="dataForm.returnMoneySts == 7" label-width="10px">
  ...
  methods: {
    ...
    getRefundAddrList () {
      this.$http({
        ...
        this.addrList = data
        this.addrList.forEach(row => {
          console.log(row.defaultAddr)
          if (row.defaultAddr === 1) {
            this.dataForm.refundAddrId = row.refundAddrId
          }
        })
...
>>> .el-table--border td:first-child .cell >span{
  flex: 1;
  padding-left: 10px;
}
>>> .mod-order-order input.el-input__inner {
  border: 1;
}
</style>
