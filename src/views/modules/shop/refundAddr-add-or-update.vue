<template>
  <el-dialog
    :title="!dataForm.refundAddrId ? '新增收货地址' : '修改收货地址'"
  ...
  >
    ...
    >
      ...
      <el-form-item label="手机号码" prop="receiverMobile">
        <el-input v-model="dataForm.receiverMobile" placeholder="手机号码"></el-input>
      </el-form-item>
      <el-form-item label="公司座机" prop="receiverTelephone">
        <el-input v-model="dataForm.receiverTelephone" placeholder="公司座机"></el-input>
      </el-form-item>
      ...
      <el-form-item label="是否默认" prop="postCode">
