<template>
  <div class="mod-groupActivity">
    <el-dialog
      :title="!dataForm.groupActivityId ? '新建拼团活动' : '编辑拼团活动'"
    ...
    >
      <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="140px">
        ...
        <el-form-item label="参团人数" prop="groupNumber">
          <el-input
            type="number"
        ...
        <el-form-item label="成团有效期时间" prop="groupValidTime">
          <el-input
            type="number"
            :disabled="dataForm.activityStatus ? dataForm.activityStatus !== 1: false"
        ...
        <el-form-item label="限制购买" prop="hasMaxNum">
          <el-radio-group
            :disabled="dataForm.activityStatus ? dataForm.activityStatus !== 1: false"
        ...
        <el-form-item v-if="dataForm.hasMaxNum" label="限购数量" prop="maxNum">
          <el-input
        ...
        <el-form-item label="模拟成团" prop="hasRobot">
          <div>
            <el-radio-group
              :disabled="dataForm.activityStatus ? dataForm.activityStatus > 2: false"
        ...
        <el-form-item label="团长优惠" prop="hasLeaderPrice">
          <el-radio-group
            :disabled="dataForm.activityStatus ? dataForm.activityStatus !== 1: false"
          ...
          <div class="auxiliary-font">开启团长(开团人)优惠后，团长将享受更优惠价格，有助于提高开团率和成团率。</div>
          <div class="auxiliary-font font-color-red">注意：开启“模拟成团”时，团长也能享受团长优惠，请谨慎设置，避免资金损失。</div>
        </el-form-item>
        <el-form-item label="凑团模式" prop="hasGroupTip">
          <el-radio-group
            :disabled="dataForm.activityStatus ? dataForm.activityStatus > 2: false"
          ...
          <div class="auxiliary-font">开启凑团后，对于未参团的买家，活动商品详情页会显示未成团的团列表，买家可以直接任选一个参团，提升成团率。</div>
        </el-form-item>
        <el-form-item label="活动预热" prop="isPreheat">
          <el-radio-group
            :disabled="dataForm.activityStatus ? dataForm.activityStatus !== 1: false"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="mini" @click="submitAndManageProds()">提交并管理活动商品</el-button>
      </span>
