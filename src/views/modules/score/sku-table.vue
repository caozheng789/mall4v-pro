  ...
  <div class="mod-prod-sku-table">
    <el-form-item>
      ...
      >
        ...
        <el-table-column prop="prodName" label="商品名称" width="180" v-if="tableLeftTitles.length">
          <template slot-scope="scope">
        ...
        <el-table-column prop="partyCode" label="商品编码" width="200">
          <template slot-scope="scope">
            <el-input size="small" v-model="scope.row.partyCode"></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="weight" label="商品重量(kg)" width="160">
          <template slot-scope="scope">
            <el-input-number
              size="small"
        ...
        <el-table-column prop="volume" label="商品体积(m³)" width="160">
          <template slot-scope="scope">
            <el-input-number
              size="small"
