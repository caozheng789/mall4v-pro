<template>
  <div class="mod-marketing-coupon">
    ...
    >
      ...
      <template slot-scope="scope" slot="overdueStatus">
        <el-tag v-if="scope.row.overdueStatus === 1" size="small">未过期</el-tag>
        <el-tag v-else size="small" type="danger">过期</el-tag>
      </template>
      <template slot-scope="scope" slot="couponType">
        <el-tag v-if="scope.row.couponType == 1" size="small">代金券</el-tag>
        <el-tag v-else-if="scope.row.couponType == 2" size="small">折扣券</el-tag>
        <el-tag v-else-if="scope.row.couponType == 3" size="small">兑换券</el-tag>
      </template>

      <template slot-scope="scope" slot="putonStatus">
        <el-tag v-if="scope.row.putonStatus === 1" size="small">已投放</el-tag>
        <el-tag v-else-if="scope.row.putonStatus === 0" size="small" type="danger">等待投放</el-tag>
        <el-tag v-else size="small" type="danger">取消投放</el-tag>
      </template>
