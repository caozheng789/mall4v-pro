  ...
  <div class="distribution-level-set gray-box bottom-redius">
    <el-form class="set-form" size="mini">
      <el-form-item>
        ...
        <!-- <el-button @click="updateUserLevel" style="margin-top:15px" v-if="isUpdateData">更新用户等级</el-button> -->
        ...
        <el-table :data="dataForm.userLevels" class="elTable">
          ...
          <el-table-column prop="needAmount" label="付费会员价格" align="center" min-width="100px">
            <template slot-scope="scope">
              <div class="table-template">
                <div class="table-input-box">
          ...
          <el-table-column prop="termType" label="时间" align="center" min-width="100px">
            <template slot-scope="scope">
              <div class="table-template">
                <div class="table-input-box">
                  <span>{{scope.row.termType === 1?'日':scope.row.termType === 2?'周':scope.row.termType === 3?'月':scope.row.termType === 4?'季':'年'}}</span>
                </div>
              </div>
            </template>
          </el-table-column>
          <el-table-column prop="needGrowth" label="购买VIP所需成长值" align="center">
            <template slot-scope="scope">
              <div class="table-template">
                <div class="table-input-box">
...
export default {
  ...
  methods: {
    ...
    addRow: function () {
      ...
      level.levelName = 'VIP等级' + levelNum
