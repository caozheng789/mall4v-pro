<template>
  <div class="mod-user-userLevelCategory">
    ...
    >
      ...
      <template slot-scope="scope" slot="serviceType">
        <el-tag v-if="scope.row.serviceType === 0" size="small" type="primary">系统权益</el-tag>
        <el-tag v-else size="small" type="success">自定义权益</el-tag>
      </template>
      <template slot-scope="scope" slot="icon">
        <img :src="resourcesUrl + scope.row.icon" width="100" height="100" />
      </template>
...
<script>
import { tableOption } from '@/crud/user/userRights'
