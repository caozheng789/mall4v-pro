<template>
  <div class="mod-distribution-prod">
    ...
    >
      <template slot-scope="scope" slot="prodName">{{scope.row.product.prodName}}</template>

      <template slot-scope="scope" slot="pic">
        <img :src="scope.row.product.pic" width="100" height="100" />
      </template>
      ...
      <template slot-scope="scope" slot="menuLeft">
        <el-button
          ...
          v-if="isAuth('distribution:distributionProd:save')"
        >新增</el-button>
