<template>
  <div class="distribution-auditting-set gray-box top-redius border-bottom-gray">
    ...
    <el-form
      ...
      size="mini"
    >
      <el-form-item label="条件审核判定">
        <el-radio-group v-model="dataForm.autoCheck">
          <el-radio :label="0">人工判定</el-radio>
          <el-radio :label="1">系统判定</el-radio>
        </el-radio-group>
        <span class="tips">这里仅判断申请条件，并不自动审核通过，仍需人工审核</span>
      </el-form-item>
      <el-form-item label="申请条件">
        ...
        <div class="condition-item">
          ...
          <el-button plain @click="prodsSelectHandle" v-if="isProd">选择商品</el-button>
