<template>
  <div class="mod-hotSearch-add-or-update">
    <el-dialog title="公告管理" :close-on-click-modal="false" :visible.sync="visible">
      <el-form
        :model="dataForm"
        :rules="dataRule"
        ref="dataForm"
        ...
        label-width="90px"
      >
        <el-form-item label="是否置顶" prop="msgType">
        ...
        <el-form-item label="内容" prop="content">
          <tiny-mce v-model="dataForm.content" ref="tinyMce" v-if="visible"></tiny-mce>
        </el-form-item>
